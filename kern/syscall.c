...
sys_ipc_recv(void *dstva)
{
	...
	// @TODO this line is the key to solve the bug?
...
syscall(uint32_t syscallno, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
    ...
    // @See inc/syscall.c  keep the order of enum
	...
	switch (syscallno) {
        ...
        // add system-call for lab4 - ex6
		case (SYS_yield):
			sys_yield();
			return 0;
        // add system-call for lab4 - ex7
		case (SYS_exofork):
			return sys_exofork();
        case (SYS_page_alloc):
            return sys_page_alloc((envid_t)a1, (void *)a2, a3);
		case (SYS_page_map):
            // envid_t --> int32  ==>  uint32_t
        ...
        // added system-call for lab4 - ex8,9,10
		case (SYS_env_set_pgfault_upcall):
			return sys_env_set_pgfault_upcall(a1, (void *) a2);

        // added ipc for lab4 - ex15
		case (SYS_ipc_recv):
			return sys_ipc_recv((void *) a1);
		case (SYS_ipc_try_send):
			return sys_ipc_try_send((envid_t)a1, a2, (void *) a3, a4);

		// add spawn helper function for lab5 - ex7
